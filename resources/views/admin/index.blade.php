...
@section('content')
    ...
    <div class="row">
        <div class="col-6">
            <a href="https://opaltimecard.com/employees" class="btn btn-primary btn-lg" role="button" aria-disabled="true"><i class="mdi mdi-plus mr-2"></i>Create New Employee</a>
            <a href="https://opaltimecard.com/department" class="btn btn-primary btn-lg" role="button" aria-disabled="true"><i class="mdi mdi-plus mr-2"></i>Create New Department</a>
            <div class="card">
                <div class="card-body" >
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.attendances.length === 0) {
                        ...
                        $("#bodyData").html('<tr><td colspan="3"><center>No records found</center></td></tr>');
                    } else {
                        var bodyData = '';
